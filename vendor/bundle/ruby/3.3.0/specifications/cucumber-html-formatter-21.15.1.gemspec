# -*- encoding: utf-8 -*-
# stub: cucumber-html-formatter 21.15.1 ruby lib

Gem::Specification.new do |s|
  s.name = "cucumber-html-formatter".freeze
  s.version = "21.15.1".freeze
  ...
  s.summary = "cucumber-html-formatter-21.15.1".freeze
  ...
  s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 2.31.0".freeze])
end
