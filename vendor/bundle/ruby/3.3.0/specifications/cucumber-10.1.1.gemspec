# -*- encoding: utf-8 -*-
# stub: cucumber 10.1.1 ruby lib

Gem::Specification.new do |s|
  s.name = "cucumber".freeze
  s.version = "10.1.1".freeze
  ...
  s.summary = "cucumber-10.1.1".freeze
  ...
  s.add_runtime_dependency(%q<cucumber-cucumber-expressions>.freeze, ["> 17".freeze, "< 19".freeze])
