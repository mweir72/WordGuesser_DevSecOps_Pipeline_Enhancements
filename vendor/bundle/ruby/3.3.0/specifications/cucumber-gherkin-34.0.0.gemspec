# -*- encoding: utf-8 -*-
# stub: cucumber-gherkin 34.0.0 ruby lib

Gem::Specification.new do |s|
  s.name = "cucumber-gherkin".freeze
  s.version = "34.0.0".freeze
  ...
  s.summary = "cucumber-gherkin-34.0.0".freeze

  s.installed_by_version = "3.5.22".freeze

  s.specification_version = 4

  s.add_runtime_dependency(%q<cucumber-messages>.freeze, ["> 25".freeze, "< 29".freeze])
  s.add_development_dependency(%q<rake>.freeze, ["~> 13.1".freeze])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3.13".freeze])
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.71.2".freeze])
  ...
  s.add_development_dependency(%q<rubocop-performance>.freeze, ["~> 1.23.1".freeze])
