# -*- encoding: utf-8 -*-
# stub: cucumber-core 15.3.0 ruby lib

Gem::Specification.new do |s|
  s.name = "cucumber-core".freeze
  s.version = "15.3.0".freeze
  ...
  s.summary = "cucumber-core-15.3.0".freeze

  s.installed_by_version = "3.5.22".freeze

  s.specification_version = 4

  s.add_runtime_dependency(%q<cucumber-gherkin>.freeze, ["> 27".freeze, "< 35".freeze])
  s.add_runtime_dependency(%q<cucumber-messages>.freeze, ["> 26".freeze, "< 30".freeze])
  s.add_runtime_dependency(%q<cucumber-tag-expressions>.freeze, ["> 5".freeze, "< 9".freeze])
  s.add_development_dependency(%q<rake>.freeze, ["~> 13.3".freeze])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3.13".freeze])
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.80.0".freeze])
  s.add_development_dependency(%q<rubocop-packaging>.freeze, ["~> 0.6.0".freeze])
  s.add_development_dependency(%q<rubocop-rake>.freeze, ["~> 0.7.0".freeze])
