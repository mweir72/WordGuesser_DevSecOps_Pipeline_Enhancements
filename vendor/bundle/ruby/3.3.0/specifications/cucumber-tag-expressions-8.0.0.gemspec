# -*- encoding: utf-8 -*-
# stub: cucumber-tag-expressions 8.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-tag-expressions-8.0.0".freeze
  ...
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.47.0".freeze])
